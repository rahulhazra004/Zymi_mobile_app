...
public class Select_Adapter extends RecyclerView.Adapter<Select_Adapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View view) {
            ...
            editAddress = (Button) view.findViewById(R.id.editAddress);
        }
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.ck.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (holder.ck.isChecked()){
                    clickListener.onSelect(buttonView,position,products.get(position));
                }
            }
        });
        ...
        holder.editAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clickListener.onClick(products.get(position));
            }
        });
    ...
    public interface ClickListener {
        void onClick(Address position);

        void onLongClick(View view, int position);

        void onSelect(View view, int position,Address address);
