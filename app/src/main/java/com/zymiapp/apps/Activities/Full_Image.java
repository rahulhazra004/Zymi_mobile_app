    ...
    private void displayMetaInfo(final int position) {
        ...
        btn_download.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    downloadImage(images.get(position).getImg_url(),cat_name_s);
                }catch (NullPointerException e){
                    Toast.makeText(Full_Image.this, "Try Again", Toast.LENGTH_SHORT).show();
                }catch (IndexOutOfBoundsException e){
                    Toast.makeText(Full_Image.this, "Try Again", Toast.LENGTH_SHORT).show();
                }
        ...
        btm_share = (Button) findViewById(R.id.share_btn);
        btm_share.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                try{
                    shareImage();
        ...
        btn_buy_now = (Button) findViewById(R.id.buy_btn);
