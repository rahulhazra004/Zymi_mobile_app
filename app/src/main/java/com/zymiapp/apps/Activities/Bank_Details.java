...
public class Bank_Details extends AppCompatActivity {
    ...
    private static final String GET_DETAILS_URL = "https://www.resellingapp.com/apiv2/zymi/rest_server/allResellerOBankDetails/API-KEY/123456";
    private static final String INSERT_DETAILS_URL = "https://www.resellingapp.com/apiv2/zymi/rest_server/getResellerBankDetails/API-KEY/123456";
...
Toolbar toolbar;
    ...
    customer_session = new Customer_Session(getApplicationContext());
        ...
        //btn.setBackgroundColor(R.color.prev_color);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status.equals("200")){
                                ...
                                name.setText(jsonObject1.getString("ac_holder_name"));
