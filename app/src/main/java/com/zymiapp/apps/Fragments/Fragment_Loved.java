...
public class Fragment_Loved extends Fragment {
    ...
    private static final String FAV_URL = "https://www.resellingapp.com/apiv2/zymi/rest_server/userLove/API-KEY/123456";
    private static final String LIKE_URL = "https://www.resellingapp.com/apiv2/zymi/rest_server/userlikelist/API-KEY/123456";
                        ...
                        try {
                            ...
                            if (status.equals("200")){
                                ...
                                for (int i=0;i<jsonArray1.length();i++){
                                    ...
                                    Fav fav = new Fav("",actual_price,selling_p,img_url,false,img_id,count_all,true,image_name,catlogue_id);
                                    favs.add(fav);
                                }
                                ...
                                mAdapter = new Fav_Adapter(getActivity(), favs, new Fav_Adapter.ClickListener() {
                                    ...
                                    @Override
                                    public void onImgClick(View view, int position) {
                                        if(favs.get(position).getCatlogue_id().equals("0")){
                                            Intent intent = new Intent(getActivity(),Full_Image.class);
                                            Bundle data = new Bundle();
                                            data.putSerializable("images", (Serializable) images);
                                            intent.putExtra("ca",data);
                                            ...
                                            Intent intent = new Intent(getActivity(),Cat_Details.class);
                                            intent.putExtra("cat_id",favs.get(position).getCatlogue_id());
                                            startActivity(intent);
                                        }
                                    }
