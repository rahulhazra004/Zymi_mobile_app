...
import com.zymiapp.apps.Activities.Diary_Full;
...
import com.zymiapp.apps.Model.Diary;
...
public class Fragment_Diaries extends Fragment {
    ...
    private static final String DIARY_URL = "https://www.resellingapp.com/apiv2/zymi/rest_server/getDiariesContents/API-KEY/123456";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (status.equals("200")){
                                ...
                                cat_name.setText(diaries.get(0).getCat_name());
